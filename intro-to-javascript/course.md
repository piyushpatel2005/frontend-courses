...
description: Learn JavaScript from the ground up — variables, functions, arrays, objects, OOP, and async programming, all in an interactive coding environment.
language: javascript
level: Beginner
sort_order: 3
modules:
  ...
  - slug: arrays
    title: Arrays
    sort_order: 5
  - slug: objects-and-built-ins
    title: Objects and Built-ins
    sort_order: 6
