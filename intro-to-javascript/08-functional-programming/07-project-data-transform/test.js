...
test("logs the mission result", () => {
  assert.includes(OUTPUT, "5 items in stock", "Log the mission result with console.log()");
});

test("logs the mission result", () => {
  assert.includes(OUTPUT, "Top products: Laptop, Monitor", "Log the mission result with console.log()");
});

test("logs the mission result", () => {
  assert.includes(OUTPUT, "Total value: $24,914", "Log the mission result with console.log()");
});
